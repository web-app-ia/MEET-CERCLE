...
/**
 * ==============================================
 * MiroTalk P2P v.1.9.31 - Configuration File
 * ==============================================
 *
...
module.exports = {
    ...
    host: {
        ...
        users: parseJsonEnv(process.env.HOST_USERS, [{ username: 'CercleMeet', password: 'CercleMeet' }]),
    ...
    // ==========================================
    stats: {
        // Désactivé par défaut dans CERCLE MEET (pas d'analytique tierce) ;
        // réactiver via STATS_ENABLED=true si vous hébergez votre propre instance.
        enabled: getEnvBoolean(process.env.STATS_ENABLED, false),
    ...
    brand: {
        ...
        about: {
            ...
            title: `CERCLE MEET — basé sur MiroTalk P2P v${packageJson.version}`,
            html: `
                <div class="about-content">
                    ...
                    <footer class="about-footer">
                        CERCLE MEET — basé sur <a href="https://github.com/miroslavpejic85/mirotalk" target="_blank" rel="noopener noreferrer">MiroTalk P2P</a> (open-source) &copy; ${new Date().getFullYear()}.
                    </footer>
                </div>
            `,
        },
