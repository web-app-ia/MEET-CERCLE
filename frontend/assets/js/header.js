...
(function () {
    ...
    var CSS = [
        ...
        '  padding:0 24px;background:#ffffff;border-bottom:1px solid #e8ecf1;',
        '  font-family:"Segoe UI",system-ui,-apple-system,BlinkMacSystemFont,Roboto,Helvetica,Arial,sans-serif;',
        '}',
        '.cm-site-header *{box-sizing:border-box}',
        '.cm-brand{display:flex;align-items:center;gap:10px;text-decoration:none;color:#0f1117;',
        '  font-weight:700;font-size:15px;letter-spacing:.04em;white-space:nowrap}',
        '.cm-brand:hover{color:#376df9}',
        '.cm-brand svg{display:block;flex:0 0 auto}',
        '.cm-site-nav{display:flex;align-items:center;gap:26px}',
        '.cm-site-nav a{position:relative;color:#6a6f82;text-decoration:none;font-weight:600;',
        '  font-size:14px;padding:6px 2px;transition:color .15s ease}',
        '.cm-site-nav a:hover{color:#376df9}',
        '.cm-site-nav a.is-active{color:#376df9}',
        '.cm-site-nav a.is-active::after{content:"";position:absolute;left:0;right:0;bottom:-2px;',
        '  height:2px;border-radius:2px;background:#376df9}',
        '.cm-site-cta{display:inline-flex;align-items:center;background:#376df9;color:#ffffff;',
        ...
        '.cm-site-cta:hover{background:#2a5ad6;color:#ffffff}',
    ...
    var LOGO_SVG =
        ...
        '<circle cx="14" cy="14" r="11.5" stroke="#376df9" stroke-width="2.5"/>' +
        '<circle cx="14" cy="14" r="4.5" fill="#376df9"/>' +
        '</svg>';
